    ...
    if($target_module) {
        if($target_module == 'module' && !$module_id) {
            ...
            switch($target_module) {
                case 'member' :
                        $query = "select count(*) as count from kport_mem_table";
                    break;
                //case 'message' :
                //        $query = "select count(*) as count from memo";
                //    break;
                case 'module' :
                        $query = sprintf("select count(*) as count from kport_%s_board", $module_id);
                    break;
            }
...
<head>
    ...
    <title>kboard2.3.0 data export tool ver 0.1</title>
    <style type="text/css">
...
<body>
    ...
    <h1>kboard2.3.0 data export tool ver 0.1</h1>
    ...
    <form action="./index.php" method="post">
        ...
        <ul>
            <li>
                kboard2.3.0 가 설치된 경로를 입력해주세요.

                <blockquote>
                    예1) e:/www/php/convert/kboard/kboard<br />
                    예2) ../../kboard<br />
                </blockquote>
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>kboard2.3.0은 회원정보와 그외 모듈 종류를 나누어 추출하실 수 있습니다.</blockquote>
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>
            ...
            다운을 받지 않고 URL을 직접 kboard2.3.0 데이터이전 모듈에 입력하여 데이터 이전하실 수도 있습니다.
        </blockquote>
    ...
    <hr />
    <address>
        powered by zero (xpressengine.com) / modify by geusgod (geusgod.pe.kr)
    </address>
</body>
</html>
