<?php
    /**
     * @brief XE XML Data Migration public class 
     * @author developer@nhn.com
     **/
    ...
    class zMigration {
        ...
        function dbConnect() {
            switch($this->db_info->db_type) {
                case 'mysql' :
                case 'mysql_innodb' :
                        $this->connect =  @mysql_connect($this->db_info->db_host, $this->db_info->db_user, $this->db_info->db_pw);
                        if(!mysql_error()) @mysql_select_db($this->db_info->db_dbname, $this->connect);
        ...
        function printMemberItem($obj) {
            ...
            // extra_vars, member extra variables
        ...
        function printPostItem($sequence, $obj, $exclude_attach = 'N') {
            print "<post>\r\n";
            // extra_vars, trackbacks, comments, attaches Information
        ...
        // get the absolute path of document
